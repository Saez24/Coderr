...
urlpatterns = [
    ...
    path('api/offerdetails/', include((offerdetail_patterns,
         'offers_app'), namespace='offerdetails')),
    path('api/orders/', include((order_patterns, 'orders_app'), namespace='orders')),
    path('api/order-count/', include((order_count_patterns,
         'orders_app'), namespace='order-count')),
    path('api/completed-order-count/', include((completed_order_count_patterns,
         'orders_app'), namespace='completed-order-count')),
]
